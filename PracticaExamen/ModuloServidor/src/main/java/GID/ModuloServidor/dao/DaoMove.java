...
public class DaoMove {
    ...
    static {
        ...
        moves.add(new Move("3","Palazo", "Golpeas con una pala a tu oponente "));
        moves.add(new Move("4","Pesadilla", "Si tu rival esta en un " +
                "sueño profundo lo atacas desde sus sueños y te lo comeh"));
    }
